...
function Get-Password {
    <#
    .SYNOPSIS
    Returns a diceware passphrase
    .DESCRIPTION
    Returns a phrase of six words of the form: adj noun adv verb adj noun
    This pattern is easier to remember than a straight diceware passphrase.
    Based on https://meet.jit.si/ room names.
    .EXAMPLE
    > New-Password
    Compulsory Revisions Under Help Dominant Characters
    .LINK
    https://github.com/shawnchin/jitsi-url-generator/blob/main/roomname_generator.js
    #>
  return (
    (Get-Random $ADJECTIVE) + " " + 
    (Get-Random $PLURALNOUN) + " " + 
    (Get-Random $ADVERB) + " " + 
    (Get-Random $VERB) + " " + 
    (Get-Random $ADJECTIVE) + " " + 
    (Get-Random $PLURALNOUN)
